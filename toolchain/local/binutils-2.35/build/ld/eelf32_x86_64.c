...
OUTPUT_ARCH(i386:x64-32)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/x86_64-pc-linux-gnu/libx32\"); SEARCH_DIR(\"=/usr/local/libx32\"); SEARCH_DIR(\"=/libx32\"); SEARCH_DIR(\"=/usr/libx32\"); SEARCH_DIR(\"=/x86_64-pc-linux-gnu/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
