...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/i386-pc-linux-gnu/lib32\"); SEARCH_DIR(\"=/x86_64-pc-linux-gnu/lib32\"); SEARCH_DIR(\"=/usr/local/lib32\"); SEARCH_DIR(\"=/lib32\"); SEARCH_DIR(\"=/usr/lib32\"); SEARCH_DIR(\"=/i386-pc-linux-gnu/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
